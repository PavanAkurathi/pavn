...
import { industryHighlights } from "../lib/docs-content";
  ...
  return (
    <div className="mt-12 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
      {MEDIA_ITEMS.map((item) => {
        const content = industryHighlights.find(
          (industry) => industry.slug === item.slug,
        );
        ...
        return (
          <CoverageMediaCard
            ...
            href={`/how-it-works/businesses#${content.slug}`}
      ...
      <div className="relative flex h-full flex-col justify-end p-6">
        ...
        >
          ...
          <div className="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-white">
            ...
            <span aria-hidden="true" className="transition duration-300 group-hover:translate-x-1 group-focus-visible:translate-x-1">
              →
            </span>
          </div>
        </div>
