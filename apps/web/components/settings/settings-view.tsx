...
export function SettingsView({
    ...
    return (
        <div className="block max-w-5xl pb-16">
            <div className="flex flex-col gap-6">
                ...
                >
                    <aside className="-mx-4 px-4 lg:w-1/5 lg:px-0">
                        <TabsList className="flex h-auto flex-col gap-1 bg-transparent p-0">
                            <TabItem value="profile" icon={<User className="size-4" />} label="Profile" />
                            <TabItem value="security" icon={<Shield className="size-4" />} label="Security" />
