            ...
            <div className="container mx-auto px-6 max-w-3xl">
                ...
                <Accordion type="single" collapsible className="w-full space-y-4">
                    ...
                    <AccordionItem value="item-1" className="border border-slate-200 bg-white rounded-lg px-4">
                        <AccordionTrigger className="text-lg font-medium text-slate-900">Is it really unlimited staff for $20?</AccordionTrigger>
                    ...
                    <AccordionItem value="item-2" className="border border-slate-200 bg-white rounded-lg px-4">
                        <AccordionTrigger className="text-lg font-medium text-slate-900">Does it integrate with my Payroll?</AccordionTrigger>
                        <AccordionContent className="text-slate-600 pb-4">
                    ...
                    <AccordionItem value="item-3" className="border border-slate-200 bg-white rounded-lg px-4">
                        <AccordionTrigger className="text-lg font-medium text-slate-900">Is there a contract?</AccordionTrigger>
                        <AccordionContent className="text-slate-600 pb-4">
                    ...
                    <AccordionItem value="item-4" className="border border-slate-200 bg-white rounded-lg px-4">
                        <AccordionTrigger className="text-lg font-medium text-slate-900">How does the Geofencing work?</AccordionTrigger>
                        <AccordionContent className="text-slate-600 pb-4">
