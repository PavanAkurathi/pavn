...
const aliases = {
    ...
    '@repo/contracts/billing': join(monorepoRoot, 'packages/contracts/src/billing.ts'),
    '@repo/contracts/onboarding': join(monorepoRoot, 'packages/contracts/src/onboarding.ts'),
    '@repo/contracts/organizations': join(monorepoRoot, 'packages/contracts/src/organizations.ts'),
    '@repo/contracts/preferences': join(monorepoRoot, 'packages/contracts/src/preferences.ts'),
    '@repo/contracts/shifts': join(monorepoRoot, 'packages/contracts/src/shifts.ts'),
    '@repo/contracts/workforce': join(monorepoRoot, 'packages/contracts/src/workforce.ts'),
    '@repo/billing': join(monorepoRoot, 'packages/billing/src/index.ts'),
    '@repo/dub': join(monorepoRoot, 'packages/dub/src/index.ts'),
