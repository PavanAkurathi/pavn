...
const describeExploration =
    process.env.RUN_EXPLORATION_DB_TESTS === "true" ? describe : describe.skip;

describeExploration("TENANT-001 Exploration: Availability Query Leak", () => {
    let orgA: any;
    let orgB: any;
    let workerOrgA: any;
    let workerOrgB: any;
 ...
 * 
 * Fix location: packages/scheduling-timekeeping/src/modules/shifts/publish.ts line 226-231
