...
export const cancelShiftController = async (shiftId: string, orgId: string, userId: string): Promise<Response> => {
    ...
    return Response.json({ success: true, message: "Shift cancelled successfully" });
};
